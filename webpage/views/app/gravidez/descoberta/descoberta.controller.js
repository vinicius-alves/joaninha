...
angular.module('app')
.controller('Descoberta.Controller', Controller);

/**
* @ngdoc controller
* @name Joaninha.controller:Descoberta
* @requires Joaninha.service:httpRequestInterceptor
* @requires Joaninha.controller:Bebes
* @description
* Controller da view "app.gravidez.descoberta".<br/> 
...
function Controller($scope,$rootScope,$http,$localStorage,apiVersao){
	...
	$rootScope.global_proxima = "app/gravidez/mamae";
